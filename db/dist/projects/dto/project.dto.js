...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Revamp the company website' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: ['member', 'admin'], default: 'member' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsIn)(['member', 'admin']),
    __metadata("design:type", String)
